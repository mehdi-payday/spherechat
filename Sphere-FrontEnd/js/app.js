			...
			$('[class*="menu-smart"]').smartmenus({
				...
				showFunction: function($ul, complete) {
					$('#chart').on('click', function(){
						if(verify == false){
							$ul.fadeIn(1000, 'linear', complete);
							verify = true;
							console.log("" + verify);
							$('#shww').hide();
							var numDownload = 0;
							$('#shww').text("" + numDownload);
						}
						else{
							return false;
						}
				...
				hideFunction: function($ul, complete) {
					...
					window.onclick = function(){
						if(verify == true){
							$ul.fadeOut(500, 'linear', complete);
							verify = false;
							console.log("" + verify);
							this.showFunction = function(){return false; console.log("disabled")};
						}
