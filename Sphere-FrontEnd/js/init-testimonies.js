...
(function($, window, document) {
    ...
    jQuery(document).ready(function($) {
                ...
                if ($('header#top .container .span_9 > .slide-out-widget-area-toggle').length > 0) {
                    ...
                    if ($('body.mobile').length > 0) {
                        ...
                        if ($('body.ascend').length > 0) {
                            ...
                            $('.slide-out-hover-icon-effect').css({
                                'top': adminBarHeight + secondaryBarHeight + parseInt($('header#top nav >ul .slide-out-widget-area-toggle').css('padding-top')) + parseInt($('#header-outer').css('padding-top')),
                                'right': parseInt($('#header-outer header >.container').css('padding-right')) + 1 + parseInt($('header#top nav ul .slide-out-widget-area-toggle').css('margin-right'))
                            });
                        }
        ...
        function fullscreenMenuInit() {
            ...
            setTimeout(function() {
                $('#slide-out-widget-area.fullscreen-alt .menu li, #slide-out-widget-area.slide-out-from-right-hover .off-canvas-menu-container .menu li').each(function() {
